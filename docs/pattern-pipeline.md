# RSE-CEP Pattern Pipeline

AI-assisted content pipeline for the CDL Research Software Engineering Capacity Enhancement Project (RSE-CEP). Source document extraction → structured markdown → PR/CI validation → GitHub Pages deployment.

**Live site:** https://rse-cep.github.io/rse-cep-content/
